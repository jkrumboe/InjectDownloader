...
document.getElementById("saveSettings").addEventListener("click", () => {
    const settings = {
      defaultDownloadPath: document.getElementById("defaultDownloadPath").value,
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    chrome.storage.sync.get("settings", (data) => {
      if (data.settings) {
        ...
        document.getElementById("askBeforeDownload").checked = data.settings.askBeforeDownload || false
